...
def generate_xmp_files(image_dir):
    ...
    command = [
        "exiftool",
        "-ext", "png",
        "-XMP:CreateDate=now",  # Ensures XMP file creation
        "-XMP:Rating=1",  # Matches Geeqie rating field
        "-dc:description=Generated by script",  # Placeholder description
        "-tagsfromfile", "@",  # Copies all metadata from image
        "-XMP:all",  # Ensures all XMP data is copied
        "-o", "%d%f.png.gq.xmp",
        image_dir
    ]
