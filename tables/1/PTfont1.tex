...
%
  \begin{flushleft}
  \captionof{figure}{\Junicode Aleksander Augezdecki, font 1. Schwabacher text
      script [Pismo tekstowe, szwabacha]. Typeface [Krój] M⁸¹. Type
      size [Stopień] 20 lines = 102—103 mm (tertia [tercja]) - Plate
      402-404 [402].}
    \label{fig:t01}
...
\noindent
    \captionof{figure}{\Junicode Aleksander Augezdecki, font 1
      extension [1b]. German letters with diacritics.[zestaw liter ze
      znakami diakrytycznymi czeskimi] Plate 402402.}
    \label{fig:t01b}
...
% https://ds.ub.uni-bielefeld.de/viewer/api/v1/records/2014414/sections/LOG_0000/pdf/
% \exdisplay \bg \gla
