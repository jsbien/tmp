...
%\newcommand{\PTglyph}[2]{\includegraphics[height=2ex]{glyphs/#2}}
...
% URL "https://github.com/jsbien/early_fonts_inventory/"
  ...
  %   \centering
%\caption{\Junicode
  Aleksander Augezdecki, font 1. Schwabacher text
      script [Pismo tekstowe, szwabacha]. Typeface [Krój] M⁸¹. Type
      size [Stopień] 20 lines = 102—103 mm (tertia [tercja]) - Plate
      402-404 [402]
    \label{fig:t01}
%  \end{figure}
  ...
  Original character set table prepared by Paulina Buchwald-Pelcowa
  
  \textbf{Primary example:}

  \textit{Testamentu Nowego Czesc Pierwsza Czterzei Euangelistowie
    swieći, Mattheusz, Marek, Lukasz I Ian, Z Greckiego ięzyka na
    Polski przelozeni i wykladem krotkiem obiasnieni}, 1551,
  \url{https://www.dbc.wroc.pl/publication/33779}
