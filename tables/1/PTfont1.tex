...
%        \textsc{Primary example:}
      ...
      \newcommand{\exampleBib}[1]{{\relsize{2}\Junicode\textbf{The example:}\\[2ex] CATALOGUS LIBRORUM item \textbf{#1}}}
...
Ewangelia Sw. Mateusza. Królewiec, [Aleksander Augezdeckij, 1551. 4°.}
...
\exampleRef{CHRISTOPHORUS RUDOLFF: Die Coss. 1553. Digitization
...
\medskip
    ...
    \exampleEN{Font 1. The text and the table including letters with Czech diacritical marks.}
    ...
    słożené.  1561.
      ...
      % Knih. 12860. Kat. dr. muz. BUW 32.
Digitization %%%%%which variant????
\url{https://cyfrowe.mnk.pl/dlibra/publication/13639/}, page 10.}
