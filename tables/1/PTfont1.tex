...
%        \textsc{Primary example:}
      ...
      \newcommand{\exampleBib}[1]{{\relsize{2}\Junicode\textbf{The example:}\\[2ex] CATALOGUS LIBRORUM \textbf{#1}}}
...
(Wystepuje u Hochfedera jako pismo 8. Tabl. 25, u Unglera jako pismo 13.
Tabl. 72). 
  
\pismoEN{Jan Haller 1. Canon [?] font. Typeface M¹⁹. Type size 10 ww. =
    128/129 mm. — Plate 164.}
...
% Note1 "Character set table prepared by Maria Błońska"
  ...
  \pismoPL{Jan Haller 2. Pismo mszalne większe. Krój M¹⁸. Stopień 10 ww. = 77 mm. — Tabl. 165.}

(Wystepuje u Hochfedera jako pismo 7. Tabl. 24, u Unglera jako pismo 12.
Tabl. 72).
...
% Note1 "Character set table prepared by Maria Błońska"
  ...
  \pismoPL{Jan Haller 3. Pismo mszalne większe. Krój M²³. Stopień 10 ww. = 136/137 mm. — Tabl. 166.}

(Wystepuje u Hochfedera jako pismo 11. Tabl. 24, u Unglera
jako pismo 11).
  
\pismoEN{Jan Haller 3. Smaller mass [?] font. Typeface M²³. Type size 10 ww. =
    136/137 mm. — Plate 166.}
...
% Note1 "Character set table prepared by Maria Błońska"
  ...
  \pismoPL{Jan Haller 4. Pismo nagłówkowe. Krój M⁸³. Stopień 20 ww. = 112/114 mm. — Tabl. 167.}

(Wystepuje u Hochfedera jako pismo 2. Tabl. 19).
  
\pismoEN{Jan Haller 4. Header font. Typeface M⁸³. Type size 20 ww. =
    112/114 mm. — Plate 167.}
...
% Note1 "Character set table prepared by Maria Błońska"
  ...
  \pismoPL{Jan Haller 5. Pismo tekstowe. Krój M⁴⁸. Stopień 20 ww. =81/82 mm. — Tabl. 168.}

(Wystepuje u Hochfedera jako pismo 9. Tabl. 26, u Unglera jako pismo 4.
Tabl. 115).
...
% Note1 "Character set table prepared by Maria Błońska"
  ...
  \pismoPL{Jan Haller 6. Pismo komentarzowe. Krój M⁹¹. Stopień 20 ww. = 82 mm (interliniowane). — Tabl. 169.}


(Wystepuje u Hochfedera jako pismo 4. Tabl. 21).
  
\pismoEN{Jan Haller 6. Text font. Typeface M⁹¹. Type size 20 ww. =
    82 mm (with extra leading). — Plate 169.}
...
FLORIAN UNGLER
KRAKÓW
PIERWSZA DRUKARNIA 1510—1516

KRAKÓW — WROCLAW — WARSZAWA
ZAKLAD NARODOWY IMIENIA OSSOLINSKICH — WYDAWNICTWO
MCMLIX
...
ZAKLAD NARODOWY I!MIENIA OSSOLINSKICH — WYDAWNICTWO
WROCLAW 1959
Wydanie I. Naklad. 820-- 180. egz..
tekst 31 (x4) tablice. Pap. druk.
Polonia typographica saeculi sedecimi zapoczgtkowana zostala przez Kazi-
mierza Piekarskiego w ostatnich latach przedwojennych. Miala ona objac
w podobiznach zasób typograficzny wszystkich tloczni polskich XVI wieku,
a przy sprzyjajgcych okolicznoSciach równiez ich monografie typograficzne.
Atoli, jak wiele naszych ambitnych przedsigwzieé, takze i to, zablysnawszy,


pracowni kazdego pi$miennictwa staropolskiego.
Pragnelibysmy w przyszlosci — jesli tylko sprzyjaé nam bed fata laskawsze
niz zalozycielowi Polonii — nastepne zeszyty z reprodukcjami poprzedzac
zwiezlg monografig, nie ograniczajgc sie do lakonicznej notatki, na której
musial poprzestaó w pierwszym zeszycie Piekarski pod dyktandem chudej
kiesy bibliotekarskiej. Juz teraz informacja wstepna, po$wiecona pierwszej
drukarni Unglerowskiej, uzyskala stosunkowo obszerne rozmiary w przeci-
wiefistwie do wiadomo$ci o Hochfederze, poniewaz zmieniona nieco po
tylu latach, jakie nas dzielg od ukazania sie monografii Piekarskiego, dokumen-
tacja zmuszala do uzupelniei oraz do zajecia w kilku przypadkach krytycznego
stanowiska wobec obserwacji jej autora. Nowo$cig równiez w stosunku do
dwóch pierwszych zeszytów, nowoscig wprowadzong, jak ufamy, na stale,
sq zestawy alfabetów reprodukowanych pism; zadania tego nasz poprzednik,
zdany wylacznie na wlasne sily, podjaé nie mógl, zapowiadajac jedynie wyko-
nanie go w lepszych czasach.
