...
Reprinted in 1968, digitized in 2020 by Kujawsko-Pomorska Biblioteka
  ...
  digitized earlier by Google Books and Hathi Trust Digital Library
  but, as of today, they are available only for searching.
...
\pismoPL{Augezdecki 1. Pisma tekstowe, szwabacha M⁸¹. Stopień 20 ww. = 102—103 mm (tercja). — Tabl. 402—404.}
...
\pismoEN{Augezdecki 1. Schwabacher text script. Typeface M⁸¹. Type size 20 lines = 102—103 mm (tertia) - Plate 402-404.}
...
\newcommand{\exampleRef}[1]{{\relsize{0}\Junicode#1}}
...
\exampleRef{\textit{Testamentu Nowego Czesc Pierwsza Czterzei Euangelistowie
    swieći, Mattheusz, Marek, Lukasz I Ian, Z Greckiego ięzyka na
    Polski przelozeni i wykladem krotkiem obiasnieni}, 1551, page
  LXXXIIIb.  Digitization
  \url{https://www.dbc.wroc.pl/publication/33779} page 202.}
...
\begin{flushleft}
\noindent
    \captionof{figure}{\Junicode Aleksander Augezdecki, font 1
      extension [1a]. Czech letters and diacritics.[zestaw liter ze
      znakami diakrytycznymi czeskimi] Plate 403.}
    \label{fig:t01a}
...
1561.
      ...
      % 2�. K. 422. Druk czarno-czerwony. War. A i B. — Estr. XIX 91.
      % Knih. 12860. Kat. dr. muz. BUW 32.
...
\begin{flushleft}
\noindent
\captionof{figure}{\Junicode Aleksander Augezdecki, font 1 extension
  [1b]. German letters with diacritics and mathematical
  notation.[zestaw liter ze znakami diakrytycznymi czeskimi] Plate
  402402.}
    \label{fig:t01b}
...
\begin{flushleft}
  \captionof{figure}{\Junicode Aleksander Augezdecki, font 2. Schwabacher text
      script [Pismo tekstowe, szwabacha]. Typeface [Krój] M⁸¹. Type
      size [Stopień] 20 lines = 86—87 mm (cicero [cycero]) - Plate
      405-406 [405].}
    \label{fig:t02}
